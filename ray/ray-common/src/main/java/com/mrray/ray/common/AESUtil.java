...
public class AESUtil {
     ...
     * 3.将加密内容解密
     */
    public static String decode(String content, String myKey) {
        try {
            //1.构造密钥生成器，指定为AES算法,不区分大小写
    ...
    public static void main(String[] args) {
        ...
        for (String key : keys) {
            ...
            String encryptString = encode(key, myKey);
            System.out.print(encryptString + " | ");
            String decryptString = decode(encryptString, myKey);
